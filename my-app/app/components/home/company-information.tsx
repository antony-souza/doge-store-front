  ...
  return (
    <div className="relative flex flex-col items-center bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 p-4 shadow-lg">
      <div className="flex items-center w-full">
        ...
        <div>
          <h1 className="text-3xl font-bold text-white tracking-wide">Doge Tacos</h1>
          <p className="text-lg text-green-300 tracking-wide">Aberto</p> {/* ou text-red-300 para "Fechado" */}
