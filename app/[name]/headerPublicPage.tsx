...
export interface IPropsHeaderPublic {
  name: string;
  cartItemCount: number; // Adicionado para passar a quantidade de itens no carrinho
}

export default function HeaderPublicPage({ name, cartItemCount }: IPropsHeaderPublic) {
